...
import us.andresgarcia.parqueadero.Authenticator;

import us.andresgarcia.controladores.*;
...
public class Main extends Application {
    ...
    private void gotoProfile() {
        try {
            ProfileController profile = (ProfileController) replaceSceneContent("../vistas/Profile.fxml");
            profile.setApp(this);
        } catch (Exception ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
